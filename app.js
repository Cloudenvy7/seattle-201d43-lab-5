...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testSumAndMultiply()
 function and see if the test passes.*/

//  //////////////////////////////////////////
// // Write your code here
// function sumAndMultiply(a, b, c) { //eslint-disable-line
//   var negSum = [-sum(a,b) - c]; 
//   // var sumAnswer = multiply(-1,negSum)
//   // return[a + ' and ' +  b  + ' and ' + c + ' sum to is ' + (sumAnswer)];
//   return negSum;
// }
...
// Write your code here
var sumArray = [2, 3, 4]; //eslint-disable-line

function sumArray(sumArr) { //eslint-disable-line
  for(var i = 0; i > sumArray.lenght(); i++) {
    var indexPlus = i + 1; 
    sum(testArray[i],testArray[indexPlus]);
  } 
  return[sumArray[0] + sumArray[1] +  sumArray[2] + 'was passed in as an array of numbers, and ' + indexSum + 'is their sum.'];
}
